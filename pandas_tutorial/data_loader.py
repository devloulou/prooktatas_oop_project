...
def validate_date_format():
    ...
    data = get_data(r"C:\WORK\Prooktatás\prooktatas\prooktatas_oop_project\pandas_tutorial\all-weeks-countries.csv")
    #print(data.index)
...
if __name__ == '__main__':
    import json
    all_weeks_country_data = get_data(r"C:\WORK\Prooktatás\prooktatas\prooktatas_oop_project\pandas_tutorial\all-weeks-countries.csv")
